...
/*
 * Brief, single-run 10 V RMS-equivalent overdrive for a 6 V tungsten lamp driven
 * from the measured 12.5 V supply through YYNMOS-1. The load still sees
 * 0/12.5 V pulses; 64.00% duty gives approximately 10.0 V RMS; reverse immediately.
 */
...
#define DUTY_TARGET                41942u
#define ASSUMED_SUPPLY_MV          12500u
#define EQUIVALENT_RMS_MV          10000u
