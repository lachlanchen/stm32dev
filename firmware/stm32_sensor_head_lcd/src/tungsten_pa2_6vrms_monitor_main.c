...
/*
 * Safe, single-run 6 V RMS-equivalent test for a 6 V tungsten lamp driven
 * from the measured 12.5 V supply through YYNMOS-1. The load still sees
 * 0/12.5 V pulses; 23.04% duty gives approximately 6.0 V RMS.
 */
...
#define DUTY_TARGET                15099u
#define ASSUMED_SUPPLY_MV          12500u
#define EQUIVALENT_RMS_MV          6000u
