...
/*
 * Independent full-output diagnostic for the 12 V tungsten lamp.
...
#define STARTUP_OFF_MS             2000u
#define FULL_ON_HOLD_MS            10000u
...
int main(void)
{
    ...
    lamp_set_duty(DUTY_MAX);
    hold_ms(FULL_ON_HOLD_MS);
    lamp_set_duty(0u);
