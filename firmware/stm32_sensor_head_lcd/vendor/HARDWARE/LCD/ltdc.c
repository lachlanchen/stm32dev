...
static volatile u32 * const ltdc_lcd_framebuf = (volatile u32 *)LCD_FRAME_BUF_ADDR;
#else
static volatile u16 * const ltdc_lcd_framebuf = (volatile u16 *)LCD_FRAME_BUF_ADDR;
#endif
...
#if LCD_PIXFORMAT==LCD_PIXFORMAT_ARGB8888||LCD_PIXFORMAT==LCD_PIXFORMAT_RGB888 
	ltdc_framebuf[0]=(u32*)LCD_FRAME_BUF_ADDR;
